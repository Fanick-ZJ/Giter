import { Branch, Remote, Author, BranchCreatedInfo, RepositoryFull, RepositorySimple, BranchStatDailyContribute, RepoFileInfo, FileStatusReport, FileLineChangeStat, FileStatus, FileDiffContext } from "@/types";
 ...
 * @param path path to the repository
*/
export declare function getCurrentBranch(path: string): Branch
/**
